...
with open('students.csv', mode='w', newline='', encoding='utf-8') as file:
    ...
    writer.writerow([106054, 'riyansh', 'riyansh@outlook.com', 2025, 'Cybersecurity', 'Certificate', 'Oncampus', 8000])
    writer.writerow([106055, 'rishik', 'rishik@outlook.com', 2025, 'Business', 'Diploma', 'Online', 10000])
